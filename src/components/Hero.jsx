  ...
  return (
    <div className='text-white'>
        <div className='max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
            <p className='text-brightGreen font-bold p-2'>GROWING WITH DATA ANALYTICS</p>
            ...
            <button className='bg-brightGreen w-[200px] rounded-md font-medium my-6 mx-auto py-3 text-black hover:bg-brightGreenLight'>Get Started</button>
        </div>
    </div>
  )
}
